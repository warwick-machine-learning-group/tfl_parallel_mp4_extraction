...
class VidLdr(object):
  ...
  def run_on_8_processors(self, in_dir, out_dir, number_videos, all_videos_frame_count, number_frames_elements, all_videos_frame_data):
...
def main(argv):
  ...
  v.run_on_8_processors(input_dir, output_dir, number_videos, all_videos_frame_count, number_frames_elements, all_videos_frame_data)
